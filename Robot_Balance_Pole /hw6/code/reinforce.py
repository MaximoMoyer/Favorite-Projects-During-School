...
class Reinforce(tf.keras.Model):
    def __init__(self, state_size, num_actions):
        ...
        self.polNet1 = tf.keras.layers.Dense(self.hidden ,activation = 'relu')
        self.policyNet =  tf.keras.layers.Dense(self.num_actions,activation = 'softmax')
    ...
    def loss(self, states, actions, discounted_rewards):
        ...
        mults = tf.multiply(tf.math.log(probs),discounted_rewards)
        output = tf.reduce_sum(-mults)
        return output
